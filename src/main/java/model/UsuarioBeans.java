...
public class UsuarioBeans {
	...
	public UsuarioBeans(int id_Usuario, String user_Usuario, String password_Usuario, int nivel_acesso_Usuario,
			String nome_Usuario, char cpf_Usuario, String complemento_Usuario, String celular_Usuario,
	...
	public char getCpf_Usuario() {
		return cpf_Usuario;
	}
	public void setCpf_Usuario(char cpf_Usuario) {
		this.cpf_Usuario = cpf_Usuario;
	}
