...
<body>
    ...
    <!-- MAIN -->
    <main>
        <h1 class="text-center mb-4">Cadastrar Pizzas</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <form class="d-grid gap-4" action="../cadastrarPizza" method="post" enctype="multipart/form-data">

                        <!-- Nome Pizza -->
                        <div class="form-group">
                            <label for="nome-pizza" class="my-2" style="font-size: 1.5em;">Nome da Pizza</label>
                            <input type="text" class="form-control" name="txtNomePizza" id="nome-pizza" placeholder="Portuguesa Especial"
                        ...
                        <div class="form-group">
                            <label for="descricao-pizza" class="mb-2 mt-4" style="font-size: 1.5em;">Descrição da
                                Pizza</label>
                            <textarea class="form-control" id="descricao-pizza" name="txtDescricaoPizza" rows="3"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="txtValorPizza" class="form-control" id="valor-pizza" placeholder="R$20,00"
                                style="font-size: 1.2em;">
